...
//               <div className="w-full lg:w-1/2">
//                 <motion.div
//                   className="rounded-lg overflow-hidden shadow-xl bg-white border border-gray-300 h-full"
//                   whileHover={{ scale: 1.03 }}
//                   transition={{ duration: 0.3 }}
//                 >
//                   {project.links.video ? (
...
//                         finalVideoSrc = `https://drive.google.com/uc?export=preview&id=${videoId}`;
//                       } else {
//                         // Direct video link
...
const Projects = () => {
  ...
  // Limit the number of displayed projects based on `showAll` state
                  ...
                  {project.links.video ? (
                    (() => {
                      ...
                      if (videoURL.includes('drive.google.com')) {
                        const match = videoURL.match(/\/d\/(.+?)\//);
                        const videoId = match ? match[1] : null;
                        finalVideoSrc = `https://drive.google.com/file/d/${videoId}/preview`;
                        return (
                          <iframe
                            title={project.title}
          ...
          {filteredProjects.length > 5 && (
            <div className="flex justify-center mt-8">
              <button
                ...
                className="px-6 py-3 bg-green-600 text-white font-medium rounded-md shadow-md hover:bg-green-500 transition-colors duration-300"
              >
